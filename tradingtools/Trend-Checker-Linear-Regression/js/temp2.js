document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        ...
        ja: {
            ...
            "problem-text1": `<p>ダウ理論とエリオット波動、まだよくわかんない。これで合ってるのかな？</p>`,
            "problem-text2": `<p>お気に入りのYouTuberみたいにチャート分析してみたけど、結局いつも感頼りになっちゃうなぁ。</p>`,
            "problem-text3": `<p>伝統的なチャート分析って、信頼できるんだろうか？もっと練習しても、あんまり効果ないなぁ。</p>`,
            ...
            "encouragement-text": `<p>心配しないで！私がついてるから、怖がることなんてないよ！<br>市場分析のことは私に任せて！</p>`,
